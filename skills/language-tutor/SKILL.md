---
name: language-tutor
description: Interactive language learning assistant. Practice vocabulary, generate exercises, track progress, and get grammar explanations.
user-invocable: true
metadata: {"openclaw.category":"productivity","openclaw.risk":"L0","openclaw.layer":"L0","openclaw.tags":"language, learning, tutor, vocabulary, grammar, education","openclaw.requires":{}}
---
...
**What it does:**
Interactive language learning assistant. Practice vocabulary, generate exercises, track progress, and get grammar explanations.
...
- "add vocab" related requests
- "quiz" related requests
- "review" related requests
- User explicitly mentions "Language" or the related platform/service
...
```json
{
  "action": "<one of: add_vocab | quiz | review | progress | list_vocab | delete_vocab | hint>",
...
const result = await execute(
  { action: "add_vocab" },  // missing required params
  context
);
