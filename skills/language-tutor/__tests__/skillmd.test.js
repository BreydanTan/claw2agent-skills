...
describe('language-tutor: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('language-tutor: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'language-tutor');
  });
...
describe('language-tutor: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('language-tutor: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('language-tutor: SKILL.md action coverage', () => {
  beforeEach(() => {});
