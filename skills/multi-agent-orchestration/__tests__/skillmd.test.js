...
describe('multi-agent-orchestration: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('multi-agent-orchestration: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'multi-agent-orchestration');
  });
...
describe('multi-agent-orchestration: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('multi-agent-orchestration: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('multi-agent-orchestration: SKILL.md action coverage', () => {
  beforeEach(() => {});
