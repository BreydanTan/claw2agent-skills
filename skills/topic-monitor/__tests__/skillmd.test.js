...
describe('topic-monitor: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('topic-monitor: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'topic-monitor');
  });
...
describe('topic-monitor: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('topic-monitor: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('topic-monitor: SKILL.md action coverage', () => {
  beforeEach(() => {});
