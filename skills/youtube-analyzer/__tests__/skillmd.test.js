...
const HANDLER_ACTIONS = ["get_video","search","get_channel","list_comments","get_transcript","get_playlist","analyze_engagement"];
...
describe('youtube-analyzer: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('youtube-analyzer: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'youtube-analyzer');
  });
...
describe('youtube-analyzer: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('youtube-analyzer: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('youtube-analyzer: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
