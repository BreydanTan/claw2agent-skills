...
const HANDLER_ACTIONS = ["search","get_page","create_page","update_page","get_database","query_database","create_database_entry","list_blocks"];
...
describe('notion-integration: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('notion-integration: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'notion-integration');
  });
...
describe('notion-integration: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('notion-integration: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('notion-integration: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
