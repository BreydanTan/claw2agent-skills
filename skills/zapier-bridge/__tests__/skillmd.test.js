...
const HANDLER_ACTIONS = ["list_zaps","run_zap","get_zap_status","list_executions"];
...
describe('zapier-bridge: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('zapier-bridge: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'zapier-bridge');
  });
...
describe('zapier-bridge: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('zapier-bridge: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('zapier-bridge: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
