...
describe('excel-handler: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('excel-handler: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'excel-handler');
  });
...
describe('excel-handler: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('excel-handler: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('excel-handler: SKILL.md action coverage', () => {
  beforeEach(() => {});
