...
const HANDLER_ACTIONS = ["search_papers","get_paper","get_citations","get_references"];
...
describe('semantic-scholar-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('semantic-scholar-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'semantic-scholar-api');
  });
...
describe('semantic-scholar-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('semantic-scholar-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('semantic-scholar-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
