...
describe('markdown-writer: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('markdown-writer: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'markdown-writer');
  });
...
describe('markdown-writer: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('markdown-writer: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('markdown-writer: SKILL.md action coverage', () => {
  beforeEach(() => {});
