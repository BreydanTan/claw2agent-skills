...
description: Create, format, and convert Markdown documents. Supports generating structured documents, tables, lists, code blocks, and converting between formats.
user-invocable: true
metadata: {"openclaw.category":"productivity","openclaw.risk":"L0","openclaw.layer":"L0","openclaw.tags":"markdown, document, writing, formatting, converter","openclaw.requires":{}}
---
...
**What it does:**
Create, format, and convert Markdown documents. Supports generating structured documents, tables, lists, code blocks, and converting between formats.
...
- User explicitly mentions "Markdown" or the related platform/service
...
```json
{
  "action": "<one of: create | table | list | codeblock | toc | format>",
