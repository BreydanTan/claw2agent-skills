...
describe('pii-redaction: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('pii-redaction: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'pii-redaction');
  });
...
describe('pii-redaction: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('pii-redaction: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('pii-redaction: SKILL.md action coverage', () => {
  beforeEach(() => {});
