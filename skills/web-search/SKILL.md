---
name: web-search
description: Search the web using DuckDuckGo. Returns relevant search results with titles, URLs, and snippets. No API key required.
user-invocable: true
metadata: {"openclaw.category":"data-research","openclaw.risk":"L0","openclaw.layer":"L0","openclaw.tags":"search, web, duckduckgo, research, internet","openclaw.requires":{}}
---
...
**What it does:**
Search the web using DuckDuckGo. Returns relevant search results with titles, URLs, and snippets. No API key required.
