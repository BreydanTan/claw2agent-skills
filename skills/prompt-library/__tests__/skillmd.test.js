...
describe('prompt-library: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('prompt-library: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'prompt-library');
  });
...
describe('prompt-library: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('prompt-library: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('prompt-library: SKILL.md action coverage', () => {
  beforeEach(() => {});
