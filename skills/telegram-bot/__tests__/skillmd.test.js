...
describe('telegram-bot: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('telegram-bot: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'telegram-bot');
  });
...
describe('telegram-bot: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('telegram-bot: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('telegram-bot: SKILL.md action coverage', () => {
  beforeEach(() => {});
