...
const HANDLER_ACTIONS = ["generate_client","validate_spec","generate_docs","convert_spec"];
...
describe('swagger-openapi-generator: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('swagger-openapi-generator: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'swagger-openapi-generator');
  });
...
describe('swagger-openapi-generator: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('swagger-openapi-generator: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('swagger-openapi-generator: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
