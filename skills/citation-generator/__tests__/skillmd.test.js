...
describe('citation-generator: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('citation-generator: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'citation-generator');
  });
...
describe('citation-generator: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('citation-generator: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('citation-generator: SKILL.md action coverage', () => {
  beforeEach(() => {});
