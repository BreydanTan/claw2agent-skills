...
const HANDLER_ACTIONS = ["send_command","get_status","navigate_to","get_inventory"];
...
describe('minecraft-bot-controller: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('minecraft-bot-controller: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'minecraft-bot-controller');
  });
...
describe('minecraft-bot-controller: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('minecraft-bot-controller: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('minecraft-bot-controller: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
