...
const HANDLER_ACTIONS = ["extract_palette","get_complementary","analyze_image","generate_palette"];
...
describe('color-palette-extractor: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('color-palette-extractor: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'color-palette-extractor');
  });
...
describe('color-palette-extractor: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('color-palette-extractor: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('color-palette-extractor: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
