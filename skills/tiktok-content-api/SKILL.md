...
user-invocable: true
metadata: {"openclaw.category":"social","openclaw.risk":"L1","openclaw.layer":"L1","openclaw.tags":"tiktok, social, video, content","openclaw.requires":{"env":["TIKTOK_CONTENT_API_API_KEY"]}}
---
...
- "get post status" related requests
- "list videos" related requests
- User explicitly mentions "TikTok" or the related platform/service
...
```json
{
  "action": "<one of: create_post | get_post_status | list_videos | get_analytics>",
