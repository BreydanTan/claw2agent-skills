...
const HANDLER_ACTIONS = ["get_repo","list_repos","create_issue","list_issues","get_issue","create_pr","list_prs","get_pr","search_code"];
...
describe('github-repo-manager: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('github-repo-manager: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'github-repo-manager');
  });
...
describe('github-repo-manager: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('github-repo-manager: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('github-repo-manager: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
