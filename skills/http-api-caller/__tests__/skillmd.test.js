...
describe('http-api-caller: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('http-api-caller: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'http-api-caller');
  });
...
describe('http-api-caller: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('http-api-caller: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('http-api-caller: SKILL.md action coverage', () => {
  beforeEach(() => {});
