...
describe('translation-hub: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('translation-hub: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'translation-hub');
  });
...
describe('translation-hub: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('translation-hub: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('translation-hub: SKILL.md action coverage', () => {
  beforeEach(() => {});
