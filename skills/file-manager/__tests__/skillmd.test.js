...
describe('file-manager: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('file-manager: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'file-manager');
  });
...
describe('file-manager: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('file-manager: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('file-manager: SKILL.md action coverage', () => {
  beforeEach(() => {});
