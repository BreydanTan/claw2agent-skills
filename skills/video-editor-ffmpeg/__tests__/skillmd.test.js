...
const HANDLER_ACTIONS = ["get_info","convert","extract_audio","thumbnail"];
...
describe('video-editor-ffmpeg: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('video-editor-ffmpeg: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'video-editor-ffmpeg');
  });
...
describe('video-editor-ffmpeg: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('video-editor-ffmpeg: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('video-editor-ffmpeg: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
