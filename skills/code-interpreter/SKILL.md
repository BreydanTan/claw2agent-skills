...
description: Execute JavaScript code in a sandboxed environment using Node.js vm module. Supports capturing console output and enforces a 10-second timeout for safe execution.
user-invocable: true
metadata: {"openclaw.category":"development-devops","openclaw.risk":"L2","openclaw.layer":"L0","openclaw.tags":"code, javascript, python, execute, interpreter, sandbox","openclaw.requires":{}}
---
...
**What it does:**
Execute JavaScript code in a sandboxed environment using Node.js vm module. Supports capturing console output and enforces a 10-second timeout for safe execution.
...
- User explicitly mentions "Code" or the related platform/service
