...
describe('code-interpreter: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('code-interpreter: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'code-interpreter');
  });
...
describe('code-interpreter: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('code-interpreter: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('code-interpreter: SKILL.md action coverage', () => {
  beforeEach(() => {});
