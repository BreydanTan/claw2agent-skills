...
describe('data-analyzer: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('data-analyzer: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'data-analyzer');
  });
...
describe('data-analyzer: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('data-analyzer: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('data-analyzer: SKILL.md action coverage', () => {
  beforeEach(() => {});
