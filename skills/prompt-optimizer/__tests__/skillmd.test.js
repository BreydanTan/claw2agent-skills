...
describe('prompt-optimizer: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('prompt-optimizer: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'prompt-optimizer');
  });
...
describe('prompt-optimizer: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('prompt-optimizer: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('prompt-optimizer: SKILL.md action coverage', () => {
  beforeEach(() => {});
