...
description: Analyze and optimize prompts for AI models. Provides scoring, suggestions, restructuring, and best-practice checks.
user-invocable: true
metadata: {"openclaw.category":"ai-ml","openclaw.risk":"L1","openclaw.layer":"L0","openclaw.tags":"prompt, optimizer, ai, quality, engineering","openclaw.requires":{}}
---
...
**What it does:**
Analyze and optimize prompts for AI models. Provides scoring, suggestions, restructuring, and best-practice checks.
...
```json
{
  "action": "<one of: analyze | optimize | score | compare>",
