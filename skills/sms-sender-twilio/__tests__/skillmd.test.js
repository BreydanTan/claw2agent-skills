...
const HANDLER_ACTIONS = ["send_sms","get_message","list_messages","send_mms","get_account","check_number"];
...
describe('sms-sender-twilio: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('sms-sender-twilio: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'sms-sender-twilio');
  });
...
describe('sms-sender-twilio: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('sms-sender-twilio: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('sms-sender-twilio: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
