...
const HANDLER_ACTIONS = ["list_events","get_event","create_event","update_event","delete_event","list_calendars","search_events"];
...
describe('google-calendar-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('google-calendar-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'google-calendar-api');
  });
...
describe('google-calendar-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('google-calendar-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('google-calendar-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
