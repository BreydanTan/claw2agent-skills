...
const HANDLER_ACTIONS = ["list_projects","get_project","create_project","list_tasks","get_task","create_task","update_task","complete_task","delete_task"];
...
describe('todoist-manager: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('todoist-manager: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'todoist-manager');
  });
...
describe('todoist-manager: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('todoist-manager: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('todoist-manager: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
