...
const HANDLER_ACTIONS = ["search","extract","search_news","search_images","get_answer","search_academic","search_code","batch_search"];
...
describe('tavily-search: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('tavily-search: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'tavily-search');
  });
...
describe('tavily-search: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('tavily-search: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('tavily-search: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
