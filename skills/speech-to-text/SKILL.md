---
name: speech-to-text
description: Transcribe audio to text with language detection, timestamps, and multiple format support
user-invocable: true
metadata: {"openclaw.category":"utilities-knowledge","openclaw.risk":"L0","openclaw.layer":"L1","openclaw.tags":"stt, whisper, audio, transcription","openclaw.requires":{"config":["providerClient"]}}
---
...
**What it does:**
Transcribe audio to text with language detection, timestamps, and multiple format support
...
- User explicitly mentions "Speech" or the related platform/service
...
```json
{
  "action": "<one of: transcribe | translate | detect_language | list_languages | list_models | transcribe_with_timestamps>",
