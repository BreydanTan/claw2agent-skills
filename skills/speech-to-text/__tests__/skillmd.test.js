...
const HANDLER_ACTIONS = ["transcribe","translate","detect_language","list_languages","list_models","transcribe_with_timestamps"];
...
describe('speech-to-text: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('speech-to-text: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'speech-to-text');
  });
...
describe('speech-to-text: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('speech-to-text: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('speech-to-text: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
