...
const HANDLER_ACTIONS = ["search_ads","get_ad_details","get_page_ads","get_ad_spend"];
...
describe('meta-ad-library-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('meta-ad-library-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'meta-ad-library-api');
  });
...
describe('meta-ad-library-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('meta-ad-library-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('meta-ad-library-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
