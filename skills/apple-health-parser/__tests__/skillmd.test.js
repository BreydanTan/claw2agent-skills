...
const HANDLER_ACTIONS = ["parse_export","get_summary","get_workouts","export_csv"];
...
describe('apple-health-parser: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('apple-health-parser: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'apple-health-parser');
  });
...
describe('apple-health-parser: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('apple-health-parser: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('apple-health-parser: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
