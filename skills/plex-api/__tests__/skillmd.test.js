...
const HANDLER_ACTIONS = ["get_libraries","search_media","get_recently_added","get_sessions"];
...
describe('plex-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('plex-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
...
describe('plex-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('plex-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('plex-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
