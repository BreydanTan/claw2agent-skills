...
describe('knowledge-base: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('knowledge-base: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'knowledge-base');
  });
...
describe('knowledge-base: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('knowledge-base: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('knowledge-base: SKILL.md action coverage', () => {
  beforeEach(() => {});
