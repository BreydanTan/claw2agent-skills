---
name: knowledge-base
description: In-memory keyword-based knowledge store. Add, search, list, and delete knowledge entries. Search uses TF-IDF-like scoring for relevance ranking.
user-invocable: true
metadata: {"openclaw.category":"utilities-knowledge","openclaw.risk":"L0","openclaw.layer":"L0","openclaw.tags":"knowledge, search, memory, store, tfidf, notes","openclaw.requires":{}}
---
...
**What it does:**
In-memory keyword-based knowledge store. Add, search, list, and delete knowledge entries. Search uses TF-IDF-like scoring for relevance ranking.
...
- User explicitly mentions "Knowledge" or the related platform/service
...
```json
{
  "action": "<one of: search | add | list | delete>",
