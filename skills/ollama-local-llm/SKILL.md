...
user-invocable: true
metadata: {"openclaw.category":"ai-ml","openclaw.risk":"L1","openclaw.layer":"L1","openclaw.tags":"ollama, llm, local, ai","openclaw.requires":{"env":["OLLAMA_LOCAL_LLM_API_KEY"]}}
---
...
- "list models" related requests
- User explicitly mentions "Ollama" or the related platform/service
...
```json
{
  "action": "<one of: generate | chat | list_models | pull_model>",
