...
const HANDLER_ACTIONS = ["translate","detect_language","translate_batch","get_usage","list_languages","get_glossaries"];
...
describe('translator-deepl-google: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('translator-deepl-google: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'translator-deepl-google');
  });
...
describe('translator-deepl-google: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('translator-deepl-google: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('translator-deepl-google: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
