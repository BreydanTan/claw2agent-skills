...
describe('meeting-summarizer: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('meeting-summarizer: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'meeting-summarizer');
  });
...
describe('meeting-summarizer: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('meeting-summarizer: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('meeting-summarizer: SKILL.md action coverage', () => {
  beforeEach(() => {});
