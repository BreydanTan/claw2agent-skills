...
describe('deep-research: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('deep-research: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'deep-research');
  });
...
describe('deep-research: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('deep-research: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('deep-research: SKILL.md action coverage', () => {
  beforeEach(() => {});
