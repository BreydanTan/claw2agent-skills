...
user-invocable: true
metadata: {"openclaw.category":"social","openclaw.risk":"L1","openclaw.layer":"L1","openclaw.tags":"social, posting, cross-platform, content","openclaw.requires":{"env":["SOCIAL_POSTER_API_KEY"]}}
---
...
- User explicitly mentions "Social" or the related platform/service
...
```json
{
  "action": "<one of: create_post | get_post | list_posts | delete_post>",
