...
describe('coding-agent: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('coding-agent: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'coding-agent');
  });
...
describe('coding-agent: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('coding-agent: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('coding-agent: SKILL.md action coverage', () => {
  beforeEach(() => {});
