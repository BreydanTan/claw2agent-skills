---
name: coding-agent
description: A meta-skill that formats structured prompts for the LLM to generate code. Accepts a task description, target language, and optional existing code context to produce a well-structured code generation request.
user-invocable: true
metadata: {"openclaw.category":"development-devops","openclaw.risk":"L2","openclaw.layer":"L0","openclaw.tags":"code, generation, agent, prompt, llm, developer","openclaw.requires":{}}
---
...
**What it does:**
A meta-skill that formats structured prompts for the LLM to generate code. Accepts a task description, target language, and optional existing code context to produce a well-structured code generation request.
...
- User explicitly mentions "Coding" or the related platform/service
