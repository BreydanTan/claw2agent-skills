---
name: note-taking
description: Create, manage, search, and organize notes with tags and folders
user-invocable: true
metadata: {"openclaw.category":"utilities-knowledge","openclaw.risk":"L0","openclaw.layer":"L0","openclaw.tags":"notes, productivity, organization","openclaw.requires":{}}
---
...
**What it does:**
Create, manage, search, and organize notes with tags and folders
...
- "create note" related requests
- "get note" related requests
- "update note" related requests
- User explicitly mentions "Note" or the related platform/service
...
```json
{
  "action": "<one of: create_note | get_note | update_note | delete_note | list_notes | search_notes | add_tag | remove_tag | move_to_folder | list_folders>",
...
const result = await execute(
  { action: "create_note" },  // missing required params
  context
);
