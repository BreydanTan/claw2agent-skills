...
const HANDLER_ACTIONS = ["create_note","get_note","update_note","delete_note","list_notes","search_notes","add_tag","remove_tag","move_to_folder","list_folders"];
...
describe('note-taking: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('note-taking: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'note-taking');
  });
...
describe('note-taking: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('note-taking: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('note-taking: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
