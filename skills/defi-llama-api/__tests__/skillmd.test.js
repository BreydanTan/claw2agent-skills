...
const HANDLER_ACTIONS = ["get_protocol_tvl","list_protocols","get_chain_tvl","get_yields"];
...
describe('defi-llama-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('defi-llama-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'defi-llama-api');
  });
...
describe('defi-llama-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('defi-llama-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('defi-llama-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
