...
const HANDLER_ACTIONS = ["get_events","get_config","get_stats","get_recordings"];
...
describe('frigate-nvr-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('frigate-nvr-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'frigate-nvr-api');
  });
...
describe('frigate-nvr-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('frigate-nvr-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('frigate-nvr-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
