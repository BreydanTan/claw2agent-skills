...
description: Generate, edit, and create variations of images using AI model APIs. Supports multiple models, sizes, quality levels, and styles. Layer 1 skill using provider client for API access.
user-invocable: true
metadata: {"openclaw.category":"ai-ml","openclaw.risk":"L1","openclaw.layer":"L1","openclaw.tags":"image, generation, ai, dall-e, art, creative, visual","openclaw.requires":{"env":["IMAGE_GENERATION_API_KEY"]}}
---
...
**What it does:**
Generate, edit, and create variations of images using AI model APIs. Supports multiple models, sizes, quality levels, and styles. Layer 1 skill using provider client for API access.
...
- "generate" related requests
- "variations" related requests
- "edit" related requests
- User explicitly mentions "Image" or the related platform/service
...
```json
{
  "action": "<one of: generate | variations | edit | list_models>",
...
const result = await execute(
  { action: "generate" },  // missing required params
  context
);
