---
name: pptx-generator
description: Generate PowerPoint presentation data structures (JSON-based slide definitions)
user-invocable: true
metadata: {"openclaw.category":"productivity","openclaw.risk":"L0","openclaw.layer":"L0","openclaw.tags":"powerpoint, pptx, presentation, slides, generator","openclaw.requires":{}}
---
...
**What it does:**
Generate PowerPoint presentation data structures (JSON-based slide definitions)
...
- "create presentation" related requests
- "add slide" related requests
- "add text" related requests
- User explicitly mentions "PPTX" or the related platform/service
...
```json
{
  "action": "<one of: create_presentation | add_slide | add_text | add_image | get_presentation | list_presentations>",
...
const result = await execute(
  { action: "create_presentation" },  // missing required params
  context
);
