...
const HANDLER_ACTIONS = ["send_email","list_messages","get_message","search_messages"];
...
describe('outlook-microsoft-graph-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('outlook-microsoft-graph-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'outlook-microsoft-graph-api');
  });
...
describe('outlook-microsoft-graph-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('outlook-microsoft-graph-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('outlook-microsoft-graph-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
