...
describe('pdf-reader: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('pdf-reader: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'pdf-reader');
  });
...
describe('pdf-reader: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('pdf-reader: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('pdf-reader: SKILL.md action coverage', () => {
  beforeEach(() => {});
