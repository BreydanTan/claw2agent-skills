---
name: pdf-reader
description: Read and extract text content from PDF files. Uses raw buffer parsing to find text between BT/ET markers and decode stream objects without external dependencies.
user-invocable: true
metadata: {"openclaw.category":"content","openclaw.risk":"L0","openclaw.layer":"L0","openclaw.tags":"pdf, reader, text-extraction, documents, parser","openclaw.requires":{}}
---
