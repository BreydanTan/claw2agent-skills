...
const HANDLER_ACTIONS = ["send_message","list_channels","get_channel","list_messages","react","create_channel","invite_user","set_topic"];
...
describe('slack-integration: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('slack-integration: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'slack-integration');
  });
...
describe('slack-integration: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('slack-integration: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('slack-integration: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
