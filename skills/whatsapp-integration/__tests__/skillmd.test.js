...
const HANDLER_ACTIONS = ["send_message","mark_read","get_messages","send_template"];
...
describe('whatsapp-integration: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('whatsapp-integration: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'whatsapp-integration');
  });
...
describe('whatsapp-integration: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('whatsapp-integration: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('whatsapp-integration: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
