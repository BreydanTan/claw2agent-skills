...
user-invocable: true
metadata: {"openclaw.category":"social","openclaw.risk":"L1","openclaw.layer":"L1","openclaw.tags":"linkedin, social, marketing, posts","openclaw.requires":{"env":["LINKEDIN_MARKETING_API_API_KEY"]}}
---
...
- User explicitly mentions "LinkedIn" or the related platform/service
...
```json
{
  "action": "<one of: create_post | get_profile | list_posts | get_analytics>",
