...
const HANDLER_ACTIONS = ["create_post","get_profile","list_posts","get_analytics"];
...
describe('linkedin-marketing-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('linkedin-marketing-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'linkedin-marketing-api');
  });
...
describe('linkedin-marketing-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('linkedin-marketing-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('linkedin-marketing-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
