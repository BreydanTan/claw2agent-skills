...
description: Access Google Trends data for keyword research and trend analysis.
user-invocable: true
metadata: {"openclaw.category":"data-research","openclaw.risk":"L0","openclaw.layer":"L1","openclaw.tags":"google, trends, seo, research","openclaw.requires":{"env":["GOOGLE_TRENDS_API_API_KEY"]}}
---
...
- "get interest" related requests
- "get related" related requests
- "compare keywords" related requests
...
```json
{
  "action": "<one of: get_interest | get_related | compare_keywords | get_trending>",
...
const result = await execute(
  { action: "get_interest" },  // missing required params
  context
);
