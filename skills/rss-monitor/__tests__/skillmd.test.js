...
describe('rss-monitor: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('rss-monitor: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'rss-monitor');
  });
...
describe('rss-monitor: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('rss-monitor: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('rss-monitor: SKILL.md action coverage', () => {
  beforeEach(() => {});
