...
const HANDLER_ACTIONS = ["synthesize","list_voices","list_languages","estimate_duration","synthesize_ssml","batch_synthesize"];
...
describe('voice-synthesizer: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('voice-synthesizer: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'voice-synthesizer');
  });
...
describe('voice-synthesizer: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('voice-synthesizer: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('voice-synthesizer: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
