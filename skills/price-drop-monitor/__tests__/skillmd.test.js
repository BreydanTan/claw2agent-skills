...
const HANDLER_ACTIONS = ["check_price","set_alert","list_alerts","remove_alert","price_history","compare_prices","find_deals","analyze_trend"];
...
describe('price-drop-monitor: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('price-drop-monitor: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'price-drop-monitor');
  });
...
describe('price-drop-monitor: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('price-drop-monitor: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('price-drop-monitor: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
