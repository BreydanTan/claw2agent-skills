...
description: Download videos from supported platforms for processing.
user-invocable: true
metadata: {"openclaw.category":"iot-media","openclaw.risk":"L1","openclaw.layer":"L1","openclaw.tags":"video, download, media, extraction","openclaw.requires":{"env":["VIDEO_DOWNLOADER_API_KEY"]}}
---
...
```json
{
  "action": "<one of: get_info | download | get_status | extract_audio>",
