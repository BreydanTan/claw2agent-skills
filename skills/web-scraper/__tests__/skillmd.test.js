...
const HANDLER_ACTIONS = ["fetch_page","extract_text","extract_links","extract_metadata","extract_structured","extract_tables"];
...
describe('web-scraper: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('web-scraper: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'web-scraper');
  });
...
describe('web-scraper: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('web-scraper: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('web-scraper: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
