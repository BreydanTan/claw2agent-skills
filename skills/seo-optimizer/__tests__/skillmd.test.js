...
const HANDLER_ACTIONS = ["analyze_page","check_keywords","get_backlinks","check_speed"];
...
describe('seo-optimizer: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('seo-optimizer: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'seo-optimizer');
  });
...
describe('seo-optimizer: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('seo-optimizer: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('seo-optimizer: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
