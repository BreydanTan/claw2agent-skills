---
name: remind-me
description: In-memory reminder system. Set timed reminders, list active reminders, or cancel pending ones.
user-invocable: true
metadata: {"openclaw.category":"productivity","openclaw.risk":"L0","openclaw.layer":"L0","openclaw.tags":"reminder, timer, productivity, schedule, notification","openclaw.requires":{}}
---
...
**What it does:**
In-memory reminder system. Set timed reminders, list active reminders, or cancel pending ones.
...
- User explicitly mentions "Remind" or the related platform/service
