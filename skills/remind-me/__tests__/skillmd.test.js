...
describe('remind-me: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('remind-me: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'remind-me');
  });
...
describe('remind-me: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('remind-me: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('remind-me: SKILL.md action coverage', () => {
  beforeEach(() => {});
