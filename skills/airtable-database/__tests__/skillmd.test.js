...
const HANDLER_ACTIONS = ["list_records","get_record","create_record","update_record","delete_record","search_records","list_bases","list_tables","bulk_create"];
...
describe('airtable-database: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('airtable-database: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'airtable-database');
  });
...
describe('airtable-database: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('airtable-database: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('airtable-database: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
