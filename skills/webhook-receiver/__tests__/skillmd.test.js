...
describe('webhook-receiver: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('webhook-receiver: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'webhook-receiver');
  });
...
describe('webhook-receiver: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('webhook-receiver: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('webhook-receiver: SKILL.md action coverage', () => {
  beforeEach(() => {});
