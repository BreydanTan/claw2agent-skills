...
const HANDLER_ACTIONS = ["list_torrents","add_torrent","remove_torrent","get_session"];
...
describe('transmission-rpc: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('transmission-rpc: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'transmission-rpc');
  });
...
describe('transmission-rpc: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('transmission-rpc: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('transmission-rpc: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
