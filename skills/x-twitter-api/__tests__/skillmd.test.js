...
const HANDLER_ACTIONS = ["get_tweet","search_tweets","get_user","get_timeline","post_tweet","get_trending","get_likes"];
...
describe('x-twitter-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('x-twitter-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'x-twitter-api');
  });
...
describe('x-twitter-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('x-twitter-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('x-twitter-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
