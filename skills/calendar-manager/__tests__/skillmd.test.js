...
describe('calendar-manager: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('calendar-manager: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'calendar-manager');
  });
...
describe('calendar-manager: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('calendar-manager: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('calendar-manager: SKILL.md action coverage', () => {
  beforeEach(() => {});
