...
const HANDLER_ACTIONS = ["get_spot_price","get_exchange_rates","list_currencies","get_buy_price","get_sell_price"];
...
describe('coinbase-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('coinbase-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'coinbase-api');
  });
...
describe('coinbase-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('coinbase-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('coinbase-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
