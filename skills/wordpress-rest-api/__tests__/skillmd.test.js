...
const HANDLER_ACTIONS = ["create_post","list_posts","update_post","delete_post","upload_media"];
...
describe('wordpress-rest-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('wordpress-rest-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'wordpress-rest-api');
  });
...
describe('wordpress-rest-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('wordpress-rest-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('wordpress-rest-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
