...
describe('email-sender: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('email-sender: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'email-sender');
  });
...
describe('email-sender: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('email-sender: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('email-sender: SKILL.md action coverage', () => {
  beforeEach(() => {});
