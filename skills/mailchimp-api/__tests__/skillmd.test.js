...
const HANDLER_ACTIONS = ["list_campaigns","get_campaign","create_campaign","list_audiences","add_subscriber","get_campaign_report","search_members"];
...
describe('mailchimp-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('mailchimp-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'mailchimp-api');
  });
...
describe('mailchimp-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('mailchimp-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('mailchimp-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
