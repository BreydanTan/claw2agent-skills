...
const HANDLER_ACTIONS = ["get_profile","get_media","list_media","search_hashtag","get_insights","get_comments","get_stories"];
...
describe('instagram-graph-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('instagram-graph-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'instagram-graph-api');
  });
...
describe('instagram-graph-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('instagram-graph-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('instagram-graph-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
