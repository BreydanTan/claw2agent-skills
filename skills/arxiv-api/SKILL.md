...
user-invocable: true
metadata: {"openclaw.category":"data-research","openclaw.risk":"L0","openclaw.layer":"L1","openclaw.tags":"arxiv, research, papers, academic","openclaw.requires":{"env":["ARXIV_API_API_KEY"]}}
---
...
- "list recent" related requests
- User explicitly mentions "arXiv" or the related platform/service
...
```json
{
  "action": "<one of: search_papers | get_paper | list_recent | get_categories>",
