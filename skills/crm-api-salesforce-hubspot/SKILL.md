---
name: crm-api-salesforce-hubspot
description: Unified CRM access for Salesforce and HubSpot — manage contacts, deals, and pipelines.
user-invocable: true
metadata: {"openclaw.category":"content","openclaw.risk":"L0","openclaw.layer":"L1","openclaw.tags":"crm, salesforce, hubspot, contacts","openclaw.requires":{"env":["CRM_API_SALESFORCE_HUBSPOT_API_KEY"]}}
---
...
- "create contact" related requests
- "list deals" related requests
...
```json
{
  "action": "<one of: find_contact | create_contact | list_deals | update_deal | get_pipeline>",
