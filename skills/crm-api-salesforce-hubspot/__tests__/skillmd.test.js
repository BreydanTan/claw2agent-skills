...
const HANDLER_ACTIONS = ["find_contact","create_contact","list_deals","update_deal","get_pipeline"];
...
describe('crm-api-salesforce-hubspot: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('crm-api-salesforce-hubspot: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'crm-api-salesforce-hubspot');
  });
...
describe('crm-api-salesforce-hubspot: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('crm-api-salesforce-hubspot: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('crm-api-salesforce-hubspot: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
