...
const HANDLER_ACTIONS = ["create_sandbox","exec_code","upload_file","close_sandbox"];
...
describe('code-sandbox-e2b: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('code-sandbox-e2b: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'code-sandbox-e2b');
  });
...
describe('code-sandbox-e2b: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('code-sandbox-e2b: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('code-sandbox-e2b: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
