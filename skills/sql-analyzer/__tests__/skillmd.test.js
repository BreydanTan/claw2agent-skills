...
const HANDLER_ACTIONS = ["analyze_query","explain_query","format_query","validate_query"];
...
describe('sql-analyzer: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('sql-analyzer: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'sql-analyzer');
  });
...
describe('sql-analyzer: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('sql-analyzer: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('sql-analyzer: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
