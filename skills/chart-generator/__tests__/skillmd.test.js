...
describe('chart-generator: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('chart-generator: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'chart-generator');
  });
...
describe('chart-generator: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('chart-generator: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('chart-generator: SKILL.md action coverage', () => {
  beforeEach(() => {});
