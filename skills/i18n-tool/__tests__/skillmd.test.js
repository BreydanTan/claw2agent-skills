...
const HANDLER_ACTIONS = ["extract_keys","translate_keys","validate_locale","merge_locales"];
...
describe('i18n-tool: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('i18n-tool: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'i18n-tool');
  });
...
describe('i18n-tool: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('i18n-tool: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('i18n-tool: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
