...
const HANDLER_ACTIONS = ["search_videos","get_video","get_channel","get_comments","get_trending","get_playlist","get_channel_videos"];
...
describe('youtube-data-api: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('youtube-data-api: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'youtube-data-api');
  });
...
describe('youtube-data-api: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('youtube-data-api: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('youtube-data-api: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
