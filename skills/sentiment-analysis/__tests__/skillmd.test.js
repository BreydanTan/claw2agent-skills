...
const HANDLER_ACTIONS = ["analyze_text","analyze_batch","detect_language","extract_entities"];
...
describe('sentiment-analysis: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('sentiment-analysis: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'sentiment-analysis');
  });
...
describe('sentiment-analysis: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('sentiment-analysis: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('sentiment-analysis: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
