...
describe('agent-council: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('agent-council: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'agent-council');
  });
...
describe('agent-council: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('agent-council: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('agent-council: SKILL.md action coverage', () => {
  beforeEach(() => {});
