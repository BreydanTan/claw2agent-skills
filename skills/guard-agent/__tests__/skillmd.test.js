...
describe('guard-agent: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('guard-agent: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'guard-agent');
  });
...
describe('guard-agent: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('guard-agent: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('guard-agent: SKILL.md action coverage', () => {
  beforeEach(() => {});
