---
name: image-upscaler
description: AI-powered image upscaling and enhancement via provider client
user-invocable: true
metadata: {"openclaw.category":"iot-media","openclaw.risk":"L1","openclaw.layer":"L1","openclaw.tags":"image, upscale, super-resolution, enhance, ai, media","openclaw.requires":{"env":["IMAGE_UPSCALER_API_KEY"]}}
---
...
- "upscale" related requests
- "enhance" related requests
- "get info" related requests
...
```json
{
  "action": "<one of: upscale | enhance | get_info | list_models | check_status>",
...
const result = await execute(
  { action: "upscale" },  // missing required params
  context
);
