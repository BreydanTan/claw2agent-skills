...
const HANDLER_ACTIONS = ["transcribe","translate","detect_language","list_models","list_formats"];
...
describe('whisper-transcribe: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('whisper-transcribe: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'whisper-transcribe');
  });
...
describe('whisper-transcribe: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('whisper-transcribe: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('whisper-transcribe: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
