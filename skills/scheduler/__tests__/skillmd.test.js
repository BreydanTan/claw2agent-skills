...
describe('scheduler: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('scheduler: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'scheduler');
  });
...
describe('scheduler: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('scheduler: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('scheduler: SKILL.md action coverage', () => {
  beforeEach(() => {});
