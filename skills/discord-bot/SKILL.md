---
name: discord-bot
description: Interact with the Discord API to send messages, get channel info, and list available channels in a guild.
user-invocable: true
metadata: {"openclaw.category":"communication","openclaw.risk":"L1","openclaw.layer":"L0","openclaw.tags":"discord, bot, messaging, community","openclaw.requires":{"env":["DISCORD_BOT_API_KEY"]}}
---
...
**What it does:**
Interact with the Discord API to send messages, get channel info, and list available channels in a guild.
...
- "getChannel" related requests
- "listChannels" related requests
- User explicitly mentions "Discord" or the related platform/service
...
```json
{
  "action": "<one of: sendMessage | getChannel | listChannels>",
