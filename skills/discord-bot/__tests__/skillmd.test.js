...
describe('discord-bot: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('discord-bot: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'discord-bot');
  });
...
describe('discord-bot: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('discord-bot: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('discord-bot: SKILL.md action coverage', () => {
  beforeEach(() => {});
