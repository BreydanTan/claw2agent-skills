...
const HANDLER_ACTIONS = ["compare_pdfs","get_text_diff","get_visual_diff","get_metadata_diff"];
...
describe('pdf-compare: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('pdf-compare: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'pdf-compare');
  });
...
describe('pdf-compare: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('pdf-compare: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('pdf-compare: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
