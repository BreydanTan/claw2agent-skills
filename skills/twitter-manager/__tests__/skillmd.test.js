...
const HANDLER_ACTIONS = ["post_tweet","get_tweet","search_tweets","get_user","get_timeline","delete_tweet","like_tweet","retweet"];
...
describe('twitter-manager: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('twitter-manager: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'twitter-manager');
  });
...
describe('twitter-manager: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('twitter-manager: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('twitter-manager: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
