...
const HANDLER_ACTIONS = ["search_questions","get_answers","post_answer","get_trending"];
...
describe('quora-zhihu-manager: SKILL.md exists', () => {
  beforeEach(() => {});
...
describe('quora-zhihu-manager: SKILL.md frontmatter', () => {
  beforeEach(() => {});
  let content, fm;
  ...
  it('frontmatter.name matches slug', () => {
    assert.equal(fm?.name, 'quora-zhihu-manager');
  });
...
describe('quora-zhihu-manager: SKILL.md metadata JSON', () => {
  beforeEach(() => {});
  let meta = null;
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('quora-zhihu-manager: SKILL.md body sections', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
...
describe('quora-zhihu-manager: SKILL.md action coverage', () => {
  beforeEach(() => {});
  let body = '';
  try {
    const content = readFileSync(SKILL_MD_PATH, 'utf8');
